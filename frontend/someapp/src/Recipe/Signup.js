    ...
    <div className='signup'>
      ...
      <form style={{ padding: '2em' }} onSubmit={(e) => e.preventDefault()}>
        <div className="mb-3">
          ...
          <input type="text" className="form-control" /* id="exampleInputEmail1"  */ aria-describedby="emailHelp" placeholder='Gaurav' value={name}
        ...
        <div className="mb-3">
          ...
          <input type="email" className="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder='gaurav@gmail.com' value={email}
